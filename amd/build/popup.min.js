...
/**
   ...
   */(CourseEvents),_jquery=(obj=_jquery)&&obj.__esModule?obj:{default:obj};let registered=!1,mctFired=!1;_exports.init=showcompletion=>{if(!registered){document.addEventListener(CourseEvents.manualCompletionToggled,(()=>{mctFired=!0})),registered=!0;var currentsection=null;(0,_jquery.default)("#gridPopup").on("show.bs.modal",(function(event){var section=currentsection;null===section&&(section=(0,_jquery.default)(event.relatedTarget).data("section"));var gml=(0,_jquery.default)("#gridPopupLabel"),triggersectionname=(0,_jquery.default)("#gridpopupsection-"+section).data("sectiontitle");gml.text(triggersectionname),(0,_jquery.default)(this).find("#gridpopupsection-"+section).addClass("active"),(0,_jquery.default)("#gridPopupCarousel").on("slid.bs.carousel",(function(){var sno=(0,_jquery.default)(".gridcarousel-item.active").data("sectiontitle");gml.text(sno)}))})),(0,_jquery.default)("#gridPopup").on("hidden.bs.modal",(function(){null!==currentsection&&(currentsection=null),(0,_jquery.default)(".gridcarousel-item").removeClass("active"),showcompletion&&mctFired&&(mctFired=!1,window.location.reload())})),(0,_jquery.default)(".grid-section .grid-modal").keypress((function(event){if(13==event.which){event.preventDefault();var trigger=(0,_jquery.default)(event.currentTarget);currentsection=trigger.data("section"),(0,_jquery.default)("#gridPopup").modal("show")}}))}}}));
